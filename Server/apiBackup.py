...
# _orig_size = None
#
# # limit queue size to avoid memory blow-up
...
#     if frame_queue.full():
#         try:
#             print("Warning Queue Exceed 30fps")
...
#     inference_to_output_queue = Queue(maxsize=5)
#     mjpeg_frame_queue = Queue(maxsize=10)
#
#     p1 = Process(target=processorTensor.processor_tensor_main, args=(inference_to_output_queue,))
#     p2 = Process(target=processOutput.process_output_main, args=(inference_to_output_queue, None, mjpeg_frame_queue))
#
#     p1.start()
#     p2.start()
#
